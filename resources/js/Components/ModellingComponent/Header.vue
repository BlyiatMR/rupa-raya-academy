<template>
  <div class="relative mx-auto py-10 z-50">
    ...
    <h1 class="sm:text-5xl text-3xl text-center tracking-wide font-extrabold bg-gradient-to-r from-gray-500 via-white to-gray-500 bg-clip-text text-transparent mt-5">3D Modelling</h1>
  </div>
</template>