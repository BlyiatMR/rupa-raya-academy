        ...
        <div class="max-w-[1440px] sm:mx-auto mx-5 py-20">
            ...
            <div class="flex justify-center gap-x-5">
                <div class="flex mt-10">
                    <a href="https://api.whatsapp.com/send?phone=+6289526791153&text=Halo Kak Saya Ingin Bertanya Seputar Rupa Raya Academy" target="_blank" class="flex items-center gap-x-3 text-white bg-blue-600 text-lg tracking-wide py-3 px-4 rounded-lg font-semibold hover:-translate-y-1 duration-300">
                        Konsultasi Sekarang 
