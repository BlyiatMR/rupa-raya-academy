...
// Import Component
import Header from '@/Components/FullstackComponent/Header.vue';
import SectionExplanation from '@/Components/FullstackComponent/SectionExplanation.vue';
import SectionMentor from '@/Components/FullstackComponent/SectionMentor.vue';
import SectionAtmosphere from '@/Components/FullstackComponent/SectionAtmosphere.vue';
import SectionTimetable from '@/Components/FullstackComponent/SectionTimetable.vue';
import SectionLearning from '@/Components/FullstackComponent/SectionLearning.vue';
import FurtherInformation from '@/Components/FullstackComponent/FurtherInformation.vue';
